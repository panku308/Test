...
<WebElementEntity>
   ...
   <name>html_Vip Recover</name>
   <tag></tag>
   <elementGuidId>1df3f23e-18a5-42a7-ac5d-f31b51263ff5</elementGuidId>
...
#katalon{font-family:monospace;font-size:13px;background-color:rgba(0,0,0,.7);position:fixed;top:0;left:0;right:0;display:block;z-index:999999999;line-height: normal} #katalon div{padding:0;margin:0;color:#fff;} #katalon kbd{display:inline-block;padding:3px 5px;font:13px Consolas,&quot;Liberation Mono&quot;,Menlo,Courier,monospace;line-height:10px;color:#555;vertical-align:middle;background-color:#fcfcfc;border:1px solid #ccc;border-bottom-color:#bbb;border-radius:3px;box-shadow:inset 0 -1px 0 #bbb;font-weight: bold} div#katalon-elementInfoDiv {color: lightblue; padding: 5px}
	...
	$(document).ready(function() {
        ...
        jQuery('#wysihtml52').wysihtml5({
        &quot;events&quot;:      {
            &quot;load&quot;: function () {
                jQuery('#wysihtml52').addClass('nicehide');
            }
        }
    });
 ...
 .nicehide {
    ...
    z-index: -1; /*Send the object to the bottom layer*/
		...
		Your Enquiry has been submitted to our team !
 You are able to view the progress of your Enquiry by viewing it at View Enquiries
                                    ...
                                    Message
                                        ...
                                         Normal text Normal textHeading 1Heading 2Heading 3Heading 4Heading 5Heading 6Black BlackSilverGreyMaroonRedPurpleGreenOliveNavyBlueOrangeBoldItalicUnderline  ×Insert linkCancelInsert link  ×Insert imageCancelInsert image
                   ...
                   Click here to attach photographs and files.
    ...
    $(document).ready(function() {
	    ...
	    $(document).ready(function() {
            ...
            $(&quot;.attach-div&quot;).on('click',&quot;.close.fileupload-exists&quot;,function(){
                checkUploadButtons();
});
        $(&quot;.attach-div&quot;).on('change','input.upload-file-input',function(){
checkUploadButtons();
        });
    function checkUploadButtons(){
        var isThereAnyBlankBtn = false;
        $(&quot;input.upload-file-input&quot;).each(function() {
                if ($(this).val() !== &quot;&quot; &amp;&amp; !isThereAnyBlankBtn) {
                    $(&quot;#moreImageUploadLink1&quot;).show();
                }else{
                    if(isThereAnyBlankBtn){
                        $(this).parents('.fileupload-new').parent('dl').remove();
                    }
                    isThereAnyBlankBtn = true;
                    $(&quot;#moreImageUploadLink1&quot;).hide();
                }
        });
    }
        ...
        $('#attachMore1').click(function() {
          ...
          /*  moreUploadTag += '&lt;div class=&quot;element&quot;>&lt;label for=&quot;upload_file&quot;' + upload_number + '>Upload File ' + upload_number + '&lt;/label>';*/
			moreUploadTag += '&lt;div class=&quot;fileupload fileupload-new&quot; data-provides=&quot;fileupload&quot;>&lt;span class=&quot;green-btn btn btn-file btn-info&quot; style=&quot;background-color:#eea236; border: 1px solid #eea236;&quot;>&lt;span class=&quot;fileupload-new&quot;>Upload file&lt;/span>&lt;span class=&quot;fileupload-exists&quot;>Change&lt;/span>&lt;input class=&quot;upload-file-input&quot; type=&quot;file&quot;  id=&quot;upload_file' + upload_number + '&quot;  name=&quot;file_array[]&quot;/>&lt;/span>&lt;span class=&quot;fileupload-preview&quot; style=&quot;color:#000000;padding-left: 5px;&quot;>&lt;/span>&lt;a href=&quot;#&quot; class=&quot;close fileupload-exists&quot; data-dismiss=&quot;fileupload&quot; style=&quot;float: none;color:#FF0000; padding-left:5px&quot;>X&lt;/a>&lt;/div>';
          ...
          //  moreUploadTag += '&amp;nbsp;&lt;a href=&quot;javascript:del_file(' + upload_number + ')&quot; style=&quot;cursor:pointer;&quot; onclick=&quot;return confirm(\&quot;Are you really want to delete ?\&quot;)&quot;>Delete ' + upload_number + '&lt;/a>&lt;/div>';
            $('&lt;dl id=&quot;delete_file' + upload_number + '&quot;>' + moreUploadTag + '&lt;/dl>').fadeIn('slow').appendTo('#moreImageUpload1');
            upload_number++;
            $(&quot;#moreImageUploadLink1&quot;).hide();
        });
    });
	 ...
	 $(document).ready(function() {
        ...
        $('#attachMore').click(function() {
            var moreUploadTag = '';
          /*  moreUploadTag += '&lt;div class=&quot;element&quot;>&lt;label for=&quot;upload_file&quot;' + upload_number + '>Upload File ' + upload_number + '&lt;/label>';*/
			moreUploadTag += '&lt;div class=&quot;fileupload fileupload-new&quot; data-provides=&quot;fileupload&quot;>&lt;span class=&quot;green-btn btn btn-file btn-info&quot;>&lt;span class=&quot;fileupload-new&quot;>Upload file&lt;/span>&lt;span class=&quot;fileupload-exists&quot;>Change&lt;/span>&lt;input type=&quot;file&quot;  class=&quot;upload-file-input&quot;   id=&quot;upload_file' + upload_number + '&quot;  name=&quot;upload_file' + upload_number + '&quot;/>&lt;/span>&lt;span class=&quot;fileupload-preview&quot; style=&quot;color:#000000;padding-left: 5px;&quot;>&lt;/span>&lt;a href=&quot;#&quot; class=&quot;close fileupload-exists&quot; data-dismiss=&quot;fileupload&quot; style=&quot;float: none;color:#FF0000; padding-left:5px&quot;>X&lt;/a>&lt;/div>';
	...
	$(document).ready(function() {
        ...
        $(function () { formWysiwyg(); });
            ...
            Privacy Policy | Refund &amp; Return Policy | Terms and Conditions | FAQ
