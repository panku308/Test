...
WebUI.setText(findTestObject('UpdateCompanyDetails/Page_Vip Recover/input_phone'), '313456789+')
...
x = WebUI.getText(findTestObject('UpdateCompanyDetails/Page_Vip Recover/div_Phone number does not allo'))

WebUI.verifyMatch(x, 'Phone number does not allow any blank spaces and alphabets , it should contain only numbers.', false)
