...
WebUI.setText(findTestObject('New Folder/Signup-OTI/Page_Vip Recover/input_email'), 'adads#com')
...
EmailError = WebUI.getText(findTestObject('New Folder/Signup-OTI/Page_Vip Recover/label_Please enter a valid ema'))

WebUI.verifyMatch(EmailError, 'Please enter a valid email address.', false)
